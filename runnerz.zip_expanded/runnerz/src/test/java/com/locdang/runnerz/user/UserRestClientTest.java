...
public class UserRestClientTest {
	...
	void shouldFindAllUsers() throws JsonProcessingException {
		// given
		User user1 = new User(1, "Leanne", "lgraham", "lgraham@gmail.com",
	...
	void shouldFindUserById() throws JsonProcessingException {
		// given
		User user = new User(1, "Leanne", "lgraham", "lgraham@gmail.com",
				new Address("Kulas Light", "Apt. 556", "Gwenborough", "92998-3874", new Geo(-37.3159, 81.1496)),
				"1-770-736-8031 x56442", "hildegard.org", new Company("Romaguera-Crona",
						"Multi-layered client-server neural-net", "harness real-time e-markets"));
		...
		assertAll("Address", () -> assertEquals(user.address().street(), "Kulas Light"),
		...
		assertAll("Company", () -> assertEquals(user.company().name(), "Romaguera-Crona"),
